...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var payload, orderRouter, analyticsRouter, verifyCertificate, viewOrders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                viewOrders = express_1.default.Router();
                viewOrders.use(payload.authenticate);
                viewOrders.get("/", function (req, res) {
                    var request = req;
                    if (!request.user)
                        return res.redirect("/sign-in?origin=view-orders");
                    var parsedUrl = (0, url_1.parse)(req.url, true);
                    var query = parsedUrl.query;
